...
/**
 * Different from {@link IncentiveKeep} in that this class checks for a shoulder.
 * <p>
 ...
 */
public final class IncentiveKeepFix implements VoluntaryIncentive, Stateless<IncentiveKeepFix>
{
    ...
    /** Singleton instance. */
    public static final IncentiveKeepFix SINGLETON = new IncentiveKeepFix();

    @Override
    public IncentiveKeepFix get()
    {
        return SINGLETON;
    }
            ...
            throws ParameterException, OperationalPlanException
    {
        ...
        if ((voluntarySpeed != null && voluntarySpeed.right() < 0) || mandatoryDesire.right() < 0
                ...
                || context.getPerception().getLaneStructure().getRootRecord(RelativeLane.RIGHT).getLane() instanceof Shoulder)
        {
